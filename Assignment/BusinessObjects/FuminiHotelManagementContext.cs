...
namespace Assignment.BusinessObjects;
...
public partial class FuminiHotelManagementContext : DbContext
{
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
    {
        if (!optionsBuilder.IsConfigured)
        {
            var configuration = new ConfigurationBuilder()
                ...
                .Build();
            string connectionString = configuration.GetConnectionString("DBDefault") 
                ?? "Server=localhost\\SQLEXPRESS;Database=FUMiniHotelManagement;User ID=sa;Password=123123;Encrypt=True;TrustServerCertificate=True;";
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Customer>(entity =>
        {
            ...
            entity.HasIndex(e => e.EmailAddress, "UQ__Customer__49A14740434798B8").IsUnique();
