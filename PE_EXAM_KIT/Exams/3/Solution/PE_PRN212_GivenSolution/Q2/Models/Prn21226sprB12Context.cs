...
public partial class Prn21226sprB12Context : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__Categori__19093A0BD6729C59");
        ...
        {
            entity.HasKey(e => e.ProductId).HasName("PK__Products__B40CC6CD495D447D");
        ...
        {
            entity.HasKey(e => e.SupplierId).HasName("PK__Supplier__4BE666B4C8136592");
